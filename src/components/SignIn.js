    ...
    const handleSubmit = (event) => {
        ...
        .then(response => {
            ...
            if(response.data.severity === "success"){
                document.cookie = `authcookie=${response.data.token}; path=/; max-age=${60*60*24*7}; samesite=none;`;
                document.cookie = `isAdmin=${response.data.admin}; path=/; max-age=${60*60*24*7}; samesite=none;`;
            }
